...
import pyhonFlask.AST_PY.ListIndex;
import pyhonFlask.AST_PY.Statement;

import java.util.ArrayList;
import java.util.List;

public class ListIdxAttributeAccess extends Statement {
    ListIndex id;
    List<Statement> attribute;
    FunctionAccess  functionAccess;
    int line;

    public ListIdxAttributeAccess(ListIndex id,FunctionAccess functionAccess,int line) {
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append("ListIdxAttributeAccess  \t l(").append(line).append(")\n");
